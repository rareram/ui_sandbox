...
const DashboardContent = () => {
  const { layouts, activeLayoutId, saveLayoutState, removeWidget, updateWidgetFilter, toast } = useDashboard();
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 bg-slate-50 dark:bg-slate-950 overflow-hidden relative">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-6">
        <ResponsiveGridLayout className="layout" layouts={{ lg: currentLayout.grid }} breakpoints={{ lg: 1200, md: 996, sm: 768, xs: 480, xxs: 0 }} cols={{ lg: 20, md: 15, sm: 10, xs: 5, xxs: 2 }} rowHeight={40} draggableHandle=".drag-handle" onLayoutChange={saveLayoutState}>
